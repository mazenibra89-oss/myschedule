    ...
    <div className="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto space-y-6 animate-fade-in">
      ...
      {showAddForm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm animate-fade-in my-auto">
          <div className="card-myits bg-[#1b1c23] border-[#2c2e3b] w-full max-w-xl rounded-2xl overflow-hidden shadow-2xl space-y-0 relative">
            ...
            <form onSubmit={handleCreateTask} className="p-6 space-y-4 max-h-[78vh] overflow-y-auto">
              <div>
